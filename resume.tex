...
{\setlength{\leftskip}{15pt}
	...
	{\fontfamily{qcs}\selectfont RideChariot.app (on-going)}
	\vspace{-5pt}
	\begin{itemize}
		\setlength{\leftskip}{15pt}
		\setlength\itemsep{-0.5em}
	...
	\end{itemize}
        ...
        % MicroPython implementation on ESP8266 via Micropython
	{\fontfamily{qcs}\selectfont My Dog Sends Me Texts (on-going)}
	\vspace{-5pt}
	\begin{itemize}
		\setlength{\leftskip}{15pt}
		\setlength\itemsep{-0.5em}
...
\begin{tabular}{l l}
	ACM Programming Team (Fall 2018)	& ICPC Team Honorable Mention Award (2018) \\
